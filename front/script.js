...
function preencherTabela() {
  ...
  dados.forEach((e) => {
    ...
    tdAdmissao.classList.add("admissao");
    tdSalario.innerHTML = e.salario;
    tdSalario.classList.add("salario");
    tdDesempenho.innerHTML = e.desempenho;
    tdDesempenho.classList.add("desempenho");
  ...
  total.innerHTML = `Total: ${dados.length} funcionários | Montante: R$ ${totalDinheiro.toFixed(
    2
  )}`;
}
